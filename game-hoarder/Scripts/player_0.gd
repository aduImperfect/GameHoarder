...
@export var collectedgames_0_exposed : Array[Node2D]
...
func _ready() -> void:
	...
	atFinalPos_0 = false
	collectedgames_0_exposed.clear()
...
func _process(_delta: float) -> void:
	...
	for j in collectedgames_0.size():
		collectedgames_0_exposed.append(collectedgames_0[j])
